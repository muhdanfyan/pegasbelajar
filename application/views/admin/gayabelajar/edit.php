<div class="row">
    <div class="col-12">
        <div class="card">
            <form role="form" method="post" action="<?= base_url('admin/gayabelajar/edit') ?>">
                <div class="card-body">
                    <div class="form-group">
                        <label for="nama_gaya_belajar">Nama Gaya Belajar</label>
                        <input type="text" name="nama_gaya_belajar" id="nama_gaya_belajar" class="form-control" id="nama_gaya_belajar" value="<?= $gaya_belajar->nama_gaya_belajar?>">
                    </div>
                    <div class="form-group">
                        <label>Title</label>
                        <input type="text" name="title" id="title" placeholder="Title" class="form-control" value="<?= $gaya_belajar->title?>">
                    </div>
